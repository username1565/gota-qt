...
//    , m_encryptionStatusIconLabel(new QLabel(this))
    ...
    , m_gotadConnectionLabel(new QLabel(this))
...
//    m_encryptionStatusIconLabel->setObjectName("m_encryptionStatusIconLabel");
    ...
    addPermanentWidget(m_gotadConnectionLabel);
...
void WalletStatusBar::setWalletModel(WalletModel* model)
{
    ...
    stateMapper_->addMapping(m_gotadConnectionLabel, WalletModel::COLUMN_LOWER_LEVEL_ERROR, "text");
