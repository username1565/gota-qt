...
const char MAIN_TX_HASH_URL[] = "https://explorer.gotanetwork.org/tx?hash=%1";
const char MAIN_BLOCK_HASH_URL[] = "https://explorer.gotanetwork.org/block?hash=%1";
const char MAIN_BLOCK_HEIGHT_URL[] = "https://explorer.gotanetwork.org/block?height=%1";
const char STAGE_TX_HASH_URL[] = "https://stage.explorer.gotanetwork.org/tx?hash=%1";
const char STAGE_BLOCK_HASH_URL[] = "https://stage.explorer.gotanetwork.org/block?hash=%1";
const char STAGE_BLOCK_HEIGHT_URL[] = "https://stage.explorer.gotanetwork.org/block?height=%1";
