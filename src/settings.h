...
//    static QString getDefaultRpcPath();
    ...
    static ConnectionMethod getGotadDefaultConnectionMethod();
...
//    QString getBuiltinRpcEndPoint() const;
    ...
    ConnectionMethod getGotadConnectionMethod() const;
    QString getGotadEndPoint() const;
    QString getGotadHost() const;
    quint16 getGotadPort() const;
...
//    QString getRpcEndPoint() const;
    ...
    quint16 getDefaultGotadPort() const;
...
//    void setRemoteRpcEndPoint(const QString& host, quint16 port);
    ...
    void setGotadConnectionMethod(ConnectionMethod method);
    void setGotadEndPoint(const QString& host, quint16 port);
