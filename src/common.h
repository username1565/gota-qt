...
constexpr const char CURRENCY_TICKER[] = "GOT";
...
constexpr const char MAIN_NET_COLOR[] = "#0000C7";
constexpr const char STAGE_NET_COLOR[] = "#000007";
constexpr const char TEST_NET_COLOR[] = "#000077";
