...
//const char COMMUNITY_FORUM_URL[] = "https://gotatalk.org";
const char COMMUNITY_FORUM_URL[] = "https://gotanetwork.org";
const char REPORT_ISSUE_URL[] = "https://gotanetwork.org";
const char DOWNLOAD_URL[] = "https://github.com/noritte/gota-gui/releases";
...
const char WINDOW_MAIN_ICON_PATH[] = ":images/gota";
const char WINDOW_STAGE_ICON_PATH[] = ":images/gota_stage";
const char WINDOW_TEST_ICON_PATH[] = ":images/gota_test";
...
void MainWindow::updateIsReady(const QString& newVersion)
{
    ...
    m_ui->m_updateLabel->setText(QString("New version %1 of Gota wallet is available.").arg(QString(QString("<a href=\"") + DOWNLOAD_URL + "\">%1</a>").arg(newVersion)));
